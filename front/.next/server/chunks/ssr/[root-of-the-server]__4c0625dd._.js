...
function HomePage() {
    ...
    const loadPosts = async ()=>{
        try {
            setLoading(true);
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPosts"])();
            setPosts(data);
        } catch (error) {
    ...
    const handleSubmitPost = async ()=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createPost"])(content, currentUser.id);
            setContent("");
            await loadPosts();
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4c0625dd._.js.map